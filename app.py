...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Lạnh - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0384388186</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Lạnh - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0384388186</div>", unsafe_allow_html=True)
